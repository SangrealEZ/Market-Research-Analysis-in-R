...
##Note: nTrials is the number of cells in the study (tasks in the conjoint analysis)

##Note it doesn't tell you the exact identity of the levels. You can choose these afterwards to best match
## marketplace realities, etc.

###############################################################
##Regression Analysis for getting part-worth estimates
setwd("/00Courses/03 Research/Lab/Lab 7 Conjoint Analysis")
